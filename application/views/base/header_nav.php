<div id="gb-header-nav">
    <div class="top-nav-info">
        <ul class="top-nav-ul fl">
            <li><a href="" class="nav-login" rel="nofollow">收藏本站</a></li>
        </ul>
        <ul class="top-nav-ul fr">
            ...
            <?php } else {?>
            <li><a href="<?php echo site_url('sign/signin');?>" class="nav-login" rel="nofollow"><?php if(!empty($this_user['nick_name'])){ echo $this_user['nick_name']; }else if(!empty($this_user['phone'])){ echo $this_user['phone']; }else if(!empty($this_user['email'])){ echo $this_user['email']; } ?></a></li>
            <li>|</li>
